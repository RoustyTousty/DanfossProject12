...
4. We shouldn't forget YAGNI principles when designing the app. We seem to create a variety of methods, but not all of them are actually necessary and used.

5. Perhaps, we shouldn't even have AssetManager injected into the optimizer. It creates unnecessary coupling, while it doesn't really provide any benefits. Why wouldn't I simply call a method in the Opmizer in a form of 
...
6. Since there is a specific order of actions, maybe it would be useful to create a facade object which does those things together. 

7. Do we ever need to save a single resultData actually, or should it become private and only SaveMany() be exposed as public?  
